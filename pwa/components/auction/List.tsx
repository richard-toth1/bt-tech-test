...
export const List: FunctionComponent<Props> = ({ auctions }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Auction List</h1>
      <Link
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {auctions &&
          ...
          auctions.map(
            (auction) =>
              auction["@id"] && (
                <tr className="py-2" key={auction["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(auction["@id"], "/auctions/[id]"),
                        name: auction["@id"],
                      }}
                    />
                  </th>
